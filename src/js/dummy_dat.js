var data = [
	{
		...
		links: [
			{
				link: 'www.example.com/portfolio',
				type: 'live website'
			},
			{
				link: 'https://github.com/tian-chaiyaporn/portfolio-code',
	...
	{
		title: 'Choose Your House Map - Sample',
		showCase: {
			frontend: ['SASS', 'jQuery (AJAX)', 'D3.js'],
			backend: [],
			design: []
		},
		techStack: {
			frontend: ['HTML5', 'SASS', 'Gulp', 'jQuery', 'D3.js'],
			backend: [],
			design: []
		},
		content: 'A map showing the house prices aroudn the US, controller provided to show timeline and other factors that may reflect the quality of living in the corresponding regions',
		links: [
			{
				link: 'www.example.con/house-prices',
				type: 'live website'
			},
			{
				link: 'github/house-prices',
				type: 'GitHub source code'
			}
		]
	},
	
	{
		...
		links: [
			{
				link: 'www.portfolio.com/tian_chaiyaporn/SuanBua',
				type: '3rd Party Portfolio Showcase Website'
			}
		]
	},
]